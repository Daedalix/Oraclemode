...
import math
import copy
import os #path_read_excel

def path_read_excel(file_name): #Improved read funcion for excel files
    data_path = str(os.getcwd() + "/Operator Advisory and Hazard Matcher/Data/" + file_name)
